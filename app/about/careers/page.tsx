  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <div className="mx-auto">
        {/* Hero Section */}
        <div ref={heroRef} className="text-center space-y-6 px-4 md:px-28" style={{ opacity: 0 }}>
          <div className="inline-block mb-4 px-4 py-2 bg-primary/10 rounded-full">
            <span className="text-sm font-semibold text-primary">Join Our Team</span>
          </div>
          {/* Main H1 heading for the careers page */}
            <h1  className="text-5xl md:text-6xl  font-bold  mb-2 text-center bg-linear-to-r from-slate-900 via-primary to-slate-900 dark:from-white dark:via-primary dark:to-white bg-clip-text text-transparent">
        Build Your Career with Lancet Software India
      </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Shape the future of business intelligence and data analytics. Join a team of passionate innovators committed
            to transforming data into actionable insights.
          </p>
        ...
        {/* Why Work With Us */}
        <div ref={whyUsRef} className="mt-20 px-4 md:px-28" style={{ opacity: 0 }}>
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 via-primary to-slate-900 dark:from-white dark:via-primary dark:to-white bg-clip-text text-transparent">
              Why Choose Lancet?
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We're more than just a workplace. We're a community of innovators dedicated to excellence.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6 bg-gradient-to-br from-primary/5 to-accent/5 p-8 rounded-2xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We invest in your professional development with training programs, certifications, and clear career
                    progression paths.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Work alongside talented professionals in a supportive atmosphere that values teamwork and
                    innovation.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6 bg-gradient-to-br from-accent/5 to-primary/5 p-8 rounded-2xl">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-primary/10 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Work on innovative projects using the latest technologies in business intelligence and data
                    analytics.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We believe in maintaining a healthy balance with flexible work arrangements and generous time-off
                    policies.
                  </p>
                </div>
              </div>
        ...
        {/* Culture */}
        <div ref={cultureRef} id="culture" className="mt-20 px-4 md:px-28" style={{ opacity: 0 }}>
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-slate-900 via-primary to-slate-900 dark:from-white dark:via-primary dark:to-white bg-clip-text text-transparent">
              Our Culture
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We foster an environment where innovation thrives and everyone can do their best work
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
              ...
              style={{ opacity: 0 }}
            >
              <div className="mb-4 inline-flex p-4 bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl group-hover:from-blue-500/20 group-hover:to-blue-600/20 transition-all">
                <Lightbulb className="w-8 h-8 text-blue-600" />
              </div>
              <h3 className="text-xl font-bold mb-3">Innovation First</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                We encourage experimentation and creative problem-solving. Your ideas matter and shape our future.
              </p>
            </div>
            ...
            <div
              ...
              style={{ opacity: 0 }}
            >
              <div className="mb-4 inline-flex p-4 bg-gradient-to-br from-yellow-500/10 to-yellow-600/10 rounded-xl group-hover:from-yellow-500/20 group-hover:to-yellow-600/20 transition-all">
                <Globe className="w-8 h-8 text-yellow-500" />
              </div>
              <h3 className="text-xl font-bold mb-3">Diversity & Inclusion</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                We celebrate diverse perspectives and create an inclusive workplace where everyone belongs.
              </p>
            </div>
            ...
            <div
              ...
              style={{ opacity: 0 }}
            >
              <div className="mb-4 inline-flex p-4 bg-gradient-to-br from-green-500/10 to-green-600/10 rounded-xl group-hover:from-green-500/20 group-hover:to-green-600/20 transition-all">
                <GraduationCap className="w-8 h-8 text-green-600" />
              </div>
              <h3 className="text-xl font-bold mb-3">Continuous Learning</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Stay ahead with ongoing training, mentorship, and access to cutting-edge technologies.
              </p>
            </div>
            ...
            <div
              ...
              style={{ opacity: 0 }}
            >
              <div className="mb-4 inline-flex p-4 bg-gradient-to-br from-orange-500/10 to-orange-600/10 rounded-xl group-hover:from-orange-500/20 group-hover:to-orange-600/20 transition-all">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            <div
              className="stats-card bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-xl p-6 text-center"
              style={{ opacity: 0 }}
            >
            ...
            <div
              className="stats-card bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 border border-yellow-500/20 rounded-xl p-6 text-center"
              style={{ opacity: 0 }}
            >
